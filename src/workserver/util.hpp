...
inline double to_multiplier (coop_pow_server::u128 const difficulty_a, coop_pow_server::u128 const base_difficulty_a)
{
...
inline coop_pow_server::u128 from_multiplier (double const multiplier_a, coop_pow_server::u128 const base_difficulty_a)
{
